...
export default function Home() {
  return (
    <div className="snap-center flex-col-reverse lg:flex-row min-h-screen relative flex justify-center items-center text-white md:py-12 lg:px-12" id="/">
    <Image fill={true} objectFit="cover" className="-z-10" src="/bg/bg.svg" alt="Bg"/>
      ...
      <div className="video-wrapper lg:w-1/2 w-screen lg:min-h-screen flex justify-center items-center">
        <iframe className="w-11/12 h-52 lg:w-5/6 sm:h-80" src="https://www.youtube.com/embed/qW3pRQ5-hS0" allow="autoplay" allowFullScreen title="YouTube Video"></iframe>
      </div>
    </div>
  );
}
