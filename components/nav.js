  ...
  return (
        <header className="fixed mt-4 top-0 w-full z-10">
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 px-2 sm:px-4 items-center justify-between bg-white rounded-md drop-shadow-md sm:drop-shadow-lg border border-slate-200">
